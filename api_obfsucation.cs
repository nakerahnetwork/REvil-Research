...
// The Algorithm is Simple we have hardcoded hashes in the binary its passed to a hash transform function do some math it hashes the functions in the export table and if if the result of the transform hash matched the hashed value generated by api_hasher() so this is our api we need 
